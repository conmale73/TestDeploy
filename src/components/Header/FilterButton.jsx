...
import { fetchInitialData } from './../LocationForm/useLocationForm';
...
function FilterButton() {
    ...
    return (
        <div>
            <button className="flex bg-[#ffbc06] px-4 py-1 items-center rounded-lg text-lg" onClick={handleCloseModal}>
                <div>
