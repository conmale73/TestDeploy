...
function PayInfo(props) {
    ...
    const { price, discount, title, slug, img, colors, brand, category } = initProductDetail;
    ...
    let productForCart = { price, discount, title, slug, img, quantity: 1, color, brand, category };
