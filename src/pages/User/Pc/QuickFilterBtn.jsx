...
function QuickFilterBtn({data,slug}) {
    const [active,setActive]= useState('')


    return (
        <Link to={data.link} className={`quickbtnPc ${slug.slug==data.id ? "activePc" :""} mx-[1rem] mb-[0.6rem] w-[120px] cursor-pointer`} id={data.id}>
